...
# @kfonts/nanum-barun-gothic-yet-hangul-otf

나눔바른고딕OTF 옛한글 폰트를 self-host 하기 위한 webfont 파일과 css 파일
(Webfont and css files package for self-hosting 나눔바른고딕OTF 옛한글 font)
...
```css
body {
    font-family: "나눔바른고딕OTF 옛한글", "나눔바른고딕OTF 옛한글", "nanum-barun-gothic-yet-hangul-otf";
}
```
