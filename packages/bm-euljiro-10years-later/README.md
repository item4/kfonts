# @kfonts/bm-euljiro-10years-later

배민 을지로10년후체 폰트를 self-host 하기 위한 webfont 파일과 css 파일
(Webfont and css files package for self-hosting 배민 을지로10년후체 font)
...
```css
body {
    font-family: "배민 을지로10년후체", "배민을지로10년후체", "bm-euljiro-10years-later";
}
```
