# @kfonts/nanum-myeongjo-eco

나눔명조 에코 폰트를 self-host 하기 위한 webfont 파일과 css 파일
(Webfont and css files package for self-hosting 나눔명조 에코 font)
...
```css
body {
    font-family: "나눔명조 에코", "나눔명조에코", "nanum-myeongjo-eco";
}
```
