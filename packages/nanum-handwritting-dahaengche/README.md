# @kfonts/nanum-handwritting-dahaengche

나눔손글씨 다행체 폰트를 self-host 하기 위한 webfont 파일과 css 파일
(Webfont and css files package for self-hosting 나눔손글씨 다행체 font)
...
```css
body {
    font-family: "나눔손글씨 다행체", "나눔손글씨 다행체", "nanum-handwritting-dahaengche";
}
```
