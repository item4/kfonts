...
# @kfonts/nanum-handwritting-jangmiche

나눔손글씨 장미체 폰트를 self-host 하기 위한 webfont 파일과 css 파일
(Webfont and css files package for self-hosting 나눔손글씨 장미체 font)
...
```css
body {
    font-family: "나눔손글씨 장미체", "나눔손글씨 장미체", "nanum-handwritting-jangmiche";
}
```
